...
<html lang="en">
  ...
  <div class="row-fluid" id="main-div">
  	...
  	<div class="row-fluid">
		...
		$myresponse = json_decode($request, true);
		echo 'this is the result for price: ' . $myresponse['results'][0]['Price'];
		print_r($myresponse['results'][0]['Price']);
	  ?>
    ...
    <div class="row-fluid info-box box-teal">
    ...
    <div class="row-fluid info-box box-green">
    ...
    <div class="row-fluid info-box box-purple">
