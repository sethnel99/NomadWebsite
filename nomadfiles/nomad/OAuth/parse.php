...
class parseRestClient{
	...
	private $appid = 'FoX2hKFWtiUIWgt2mioFIJvwdwgy461XAS7n367S';
	private $restkey = 'JHC47SBv4QXHkyXywH86woIhW7KoEIMJeDm7Qk5c';
	private $parseUrl = 'https://api.parse.com/1/';
 ...
 */
	public function get($args){
		$params = array(
			'url' => 'classes/'.$args['className'].'/'.$args['objectId'],
			'method' => 'GET'
		);
 ...
 */
	private function checkResponse($return,$code){
		...
		// 201 is a correct response code from parse!
		if($return['code'] == '201'){
 ...
 */
	...
	public function queryUser($args){
		$params = array(
			'url' => 'users/'.$args['className'],
			'method' => 'GET'
		);
...
//
// Login users using their twitter information
//
	
	
		public function twitterLogin($args){
		$params = array(
			'url' => 'users',
			'method' => 'POST',
			'payload' => $args['login']
...
/*
 * Used to update a parse.com user 
 * 
 * @param array $args - argument hash:
 * 
 * className: string of className
 ...
 */
	public function updateUser($args){
		$params = array(
			...
			'method' => 'PUT',
			'payload' => $args['object'],
			'parse_session_token' => $args['parse_session_token']
		);
